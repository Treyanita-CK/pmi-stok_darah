    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="{{ route('user.login')}}" class="nav-link px-2 link-dark">Daftar Donor Darah</a></li>
          <li><a href="{{ route('hubungi')}}" class="nav-link px-2 link-dark">Hubungi Kami</a></li>
        </ul>
        <div class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
          <a type="button" class="btn btn-primary" href="{{ route('user.login')}}">Sign In</a>
        </div>
        </div>
    </div>
</header>
