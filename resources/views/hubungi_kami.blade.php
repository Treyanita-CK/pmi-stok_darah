            ...
            <div class="card-body row">
                <div class="col-5 text-center d-flex align-items-center justify-content-center">
                    <div class="">
                        ...
                        <p class="lead mb-5">Jl. Dr. Sudarsono No. 8 Kesambi Kota Cirebon<br>
                        </p>
                    </div>
                </div>
                <div class="col-7">
                    @if(session('success_hubungi'))
                    <div class="alert alert-success">
                        {{ session('success_hubungi') }}
                    </div>
                    @endif
                    <form method="POST" action="{{ route('hubungiCreate') }}">
